...
namespace IMDB.Integrations
{
    public class ImdbClientIntegration
    {
        ...
        {
            var endpoint = new Uri(string.Concat(baseUrl, relativePath));
        ...
        {
            var url = $"/?apikey={apiKey}&s={search}&t={title}&y={year}&plot={plot}";
        ...
        {
            var url = $"/?apikey={apiKey}&i={imdbId}&plot=full";
